#Here we will discuss how to count all the possible decoding of a given digit sequence in Python. Before counting the number of decoding’s first let’s see how the numbers are assumed to be coded. 
#The decoding programs are the most possible questions asked and are largely practiced in Python programming. The program counts the number of possible decoding’s of the entered digit by the user of the given sequence.
...
#For example :- if the digit sequence is “12” then there are two possible decoding’s for this – One of them is ‘AB’ when we decode 1 as ‘A’ and 2 as ‘B’. 
#Now we can also decode this digit sequence “12” as ‘L’ when we decode digits 1 and 2 taken together as an integer 12.
